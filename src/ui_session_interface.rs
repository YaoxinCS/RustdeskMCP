...
impl<T: InvokeUiSession> Session<T> {
    fn peer_id(&self) -> String {
        self.lc.read().unwrap().get_id().to_string()
    }
    ...
    pub fn input_os_password(&self, pass: String, activate: bool) {
        if crate::agent_bridge::should_drop_user_input(&self.peer_id()) {
            return;
        }
    ...
    pub fn input_string(&self, value: &str) {
        ...
        self.input_string_agent(value);
    }

    pub fn input_string_agent(&self, value: &str) {
    ...
    pub fn queue_password(&self, password: String) {
        self.lc.write().unwrap().queue_shared_password(password);
    }

    pub fn has_login_challenge(&self) -> bool {
        self.lc.read().unwrap().has_login_challenge()
    }
