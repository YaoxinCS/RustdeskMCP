...
> [!Caution]
> **Important Legal and Ethical Notice:** <br>
...
This repository is a modified fork of the official [RustDesk](https://github.com/rustdesk/rustdesk) project and remains licensed under AGPL-3.0. It adds an embedded localhost MCP server, a separate `RustDeskMCP` app identity, and agent-oriented desktop and terminal control flows on top of the upstream RustDesk codebase.

Chinese version of this fork overview: [docs/README-ZH.md](docs/README-ZH.md)

### What this fork adds

- an embedded localhost MCP server inside the desktop Flutter client
- a separate Windows runtime identity, `RustDeskMCP`, so this fork does not collide with a normal RustDesk installation
...
- License: AGPL-3.0, see [LICENCE](LICENCE)
- Fork notice and attribution: [NOTICE.md](NOTICE.md)

If you are here for the MCP-specific behavior of this fork, continue with:

- [docs/RustDeskMCP.md](docs/RustDeskMCP.md) for the fork overview, current MCP scope, and runtime model
- [docs/README-ZH.md](docs/README-ZH.md) for the Chinese README
- [NOTICE.md](NOTICE.md) for upstream attribution, licensing, and fork notice
